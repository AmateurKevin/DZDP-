...
- (void)viewDidLoad {
    ...
    //[self.collectionView registerClass:[DPFilterHeaderView class] forSupplementaryViewOfKind:UICollectionElementKindSectionHeader withReuseIdentifier:kHeaderViewCellIdentifier];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([perSection[indexPath.row] isEqualToString:@"更多"] || [perSection[indexPath.row] isEqualToString:@"收起"]) {
...
- (UICollectionReusableView *)collectionView:(UICollectionView *)collectionView viewForSupplementaryElementOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([kind isEqual: UICollectionElementKindSectionHeader]) {
        ...
        filterHeaderView.categoryLabel.text = category.name;
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([cell.Label.text isEqualToString:@"收起"]) {
        NSArray *perSection = self.cellDataPerSection[indexPath.section];
